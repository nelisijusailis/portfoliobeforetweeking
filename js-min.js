...
["SCREEN", "LINEAR_LIGHT"].reduce((e,n,t)=>Object.assign(e, {
    [n]: t
}), {});
class MiniGl {
            ...
            Uniform: {
                ...
                value: class {
                    ...
                    getDeclaration(e, n, t) {
                        ...
                        if (i.excludeFrom !== n) {
                            if ("array" === i.type)
                                return i.value[0].getDeclaration(e, n, i.value.length) + `\nconst int ${e}_length = ${i.value.length};`;
                            if ("struct" === i.type) {
                                let s = e.replace("u_", "");
                    ...
                    setTopology(e=1, n=1) {
                        ...
                        for (let e = 0; e <= t.ySegCount; e++)
                            for (let n = 0; n <= t.xSegCount; n++) {
                                ...
                                if (t.attributes.uv.values[2 * i] = n / t.xSegCount,
            ...
            Mesh: {
                ...
                value: class {
                    ...
                    draw() {
                        ...
                        this.material.uniformInstances.forEach(({uniform: e, location: n})=>e.update(n)),
            ...
            Attribute: {
                ...
                value: class {
                    ...
                    attach(e, n) {
                        ...
                        return this.target === r.ARRAY_BUFFER && (r.enableVertexAttribArray(t),
    ...
    setOrthographicCamera(e=0, n=0, t=0, i=-2e3, s=2e3) {
        this.commonUniforms.projectionMatrix.value = [2 / this.width, 0, 0, 0, 0, 2 / this.height, 0, 0, 0, 0, 2 / (i - s), 0, e, n, t, 1],
...
class Gradient {
    ...
    async connect() {
        this.shaderFiles = {
            ...
            fragment: "varying vec3 v_color;\n\nvoid main() {\n  vec3 color = v_color;\n  if (u_darken_top == 0.0) {\n    vec2 st = gl_FragCoord.xy/resolution.xy;\n    color.g -= pow(st.y + sin(-2.0) * st.x, u_shadow_power) * .4;\n  }\n  gl_FragColor = vec4(color, 1.0);\n}"
        },
        this.conf = {
            presetName: "",
            wireframe: !1,
        ...
        document.querySelectorAll("canvas").length < 1 || (this.minigl = new MiniGl(this.el,null,null,!0),
        ...
        for (let e = 1; e < this.sectionColors.length; e += 1)
            this.uniforms.u_waveLayers.value.push(new this.minigl.Uniform({
                value: {
                    ...
                    noiseFreq: new this.minigl.Uniform({
                        value: [2 + e / this.sectionColors.length,  + e / this.sectionColors.length],
                        type: "vec2"
                    }),
                    noiseSpeed: new this.minigl.Uniform({
                        value: 1 + .3 * e
    ...
    toggleColor(e) {
        this.activeColors[e] = 0 === this.activeColors[e] ? 4 : 0
    }
    showGradientLegend() {
        this.width > this.minWidth && (this.isGradientLegendVisible = !1,
    ...
    initGradientColors() {
        this.sectionColors = ["--gradient-color-1", "--gradient-color-4", "--gradient-color-1", "--gradient-color-0"].map(e=>{
            let n = this.computedCanvasStyle.getPropertyValue(e).trim();
            if (4 === n.length) {
                const e = n.substr(1).split("").map(e=>e + e).join("");
                n = "#" + e
            }
            return n && "0x" + n.substr(3)
        }
